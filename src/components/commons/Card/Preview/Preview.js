...
export default function PreviewCard(props) {
  const previewList = [
    {
      id: "ilta0101",
      title: "Travelend를 통해 새로운 인연을 만들다",
      content: `처음 혼자 가는 해외여행이라 걱정됐었는데 Travelend를 통해 마음이 잘 맞는 동행자를 만났고 약 3박 4일 동안 정말 재미있게 여행할 수 있어습니다. 
        Travelend에서 만들어준 여행스타일 해시태그 기반으로 잘 맞는 여행 동행자를 구할 수 있어서 만족스러웠습니다. 친한 친구들과 여행가는 것만큼 재밌었습니다. 여행 이후에도 좋은 인연이 되어 자주 만나고 있어요. 
        새로운 인연을 만들어줘서 고마워요, Travelend!`,
    ...
    },
    {
      ...
      content: `극 P인 성향이라 일본 여행 계획 짜는게 너무 귀찮았는데 여행 전날 J성향이신 것 같은 분의 상세한 일본 여행 후기를 보고 참고해서 잘 다녀왔습니다. 상세하게 여정을 기록해주신 분들 덕분에 여행 계획 짤 때 도움이 많이 됐던 것 같아요. 궁금한 부분은 여행 후기 댓글을 통해 해당 여행자와 소통할 수 있어서 아주 좋습니다!
        여행자들끼리 소통할 수 있는 공간을 마련해줘서 고마워요, Travelend!
        `,
      profileUrl: "/img/preview2.png",
    },
    {
      id: "it'sTime",
      title: "여행갈 때마다 믿고 사용하는 Travelend",
  ...
  return (
    <PreviewWrapper>
      <PreviewTitle>이용자들이 말하는 Travelend</PreviewTitle>
